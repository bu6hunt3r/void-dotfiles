...
echo 'de_DE.UTF-8 UTF-8' > /mnt/etc/default/libc-locales
...
# Set cmdline
zfs set org.zfsbootmenu:commandline="ro quiet nowatchdog rd.vconsole.keymap=de" zroot/ROOT/"$root_dataset"
