...
#+begin_src emacs-lisp
  ;; (ensure-package-installed 'lsp-metals)
  ;; (let ((my-cs-path (expand-file-name "~/.local/share/coursier/bin")))
  ;;   (setenv "PATH" (concat my-cs-path ":" (getenv "PATH")))
  ;;   (add-to-list 'exec-path my-cs-path))
...
** Yequake (Drop-Down Terminal)

#+begin_src emacs-lisp
  (ensure-package-installed 'yequake)
  (require 'yequake)

  (customize-set-variable 'yequake-frames '(("Yequake & scratch" .
	   ((width . 0.75)
	    (height . 0.5)
	    (alpha . 0.95)
